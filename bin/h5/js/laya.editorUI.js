...
(function(window,document,Laya){
	...
	var Animation=laya.display.Animation,ColorFilter=laya.filters.ColorFilter,Component1=laya.ui.Component;
	var Ease=laya.utils.Ease,Event=laya.events.Event,EventDispatcher=laya.events.EventDispatcher,FileManager=laya.ide.managers.FileManager;
	var Font=laya.display.css.Font,GraphicAnimation=laya.display.GraphicAnimation,Graphics=laya.display.Graphics;
	var HTMLDivElement=laya.html.dom.HTMLDivElement,HTMLImage=laya.resource.HTMLImage,Handler=laya.utils.Handler;
	var HttpRequest=laya.net.HttpRequest,IDEAPIS=laya.ide.managers.IDEAPIS,Image1=laya.ui.Image,Input=laya.display.Input;
	var Loader1=laya.net.Loader,MathUtil=laya.maths.MathUtil,MovieClip=laya.ani.swf.MovieClip,Node=laya.display.Node;
	...
	var Sprite=laya.display.Sprite,Text1=laya.display.Text,Texture=laya.resource.Texture,Tween=laya.utils.Tween;
	...
	*/
	...
	var ControlPoint=(function(_super){
		...
		ControlPoint.getControlPoint=function(start,end,draging){
			var rst;
	...
	*/
	...
	var SpritePlayer=(function(_super){
		...
		Laya.imps(__proto,{"laya.editorUI.IBox":true})
	...
	*/
	...
	var DrawLines=(function(_super){
		...
		__proto._displayChange=function(){
			this.on(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this._mMouseDown);
			this.off(/*laya.events.Event.MOUSE_DOWN*/"mousedown",this,this._mMouseDown);
			this.drawSelf();
		}

		__proto._mMouseDown=function(){}
		__proto.getPointsByStr=function(str){
			var pointArr;
			pointArr=str.split(",");
			var i=0,len=0;
		...
		__proto.drawSelf=function(){
			...
			if (this.isSelectState && this.displayedInStage){
				...
				for (i=0;i < len;i+=2){
					tsp=ControlPoint.getControlPoint(this._start,this._end,this._draging);
	...
	*/
	...
	var ParticlePlayer=(function(_super){
		...
		Laya.imps(__proto,{"laya.editorUI.IComponent":true})
		__proto._getBoundPointsM=function(ifRotate){
			(ifRotate===void 0)&& (ifRotate=false);
			if (this._width > 0 && this._height > 0 && !this.autoSize){
				if (!this._mMBounds){
	...
	*/
	...
	var AnimationPlayer=(function(_super){
		...
		__proto.loadAnimation=function(url,loaded){
			...
			return _super.prototype.loadAnimation.call(this,url,loaded,true);
		}
	...
	*/
	...
	var Button=(function(_super){
		...
		__proto.createText=function(){
			if (!this._text){
				this._text=new Text();
				this._text.overflow=Text1.HIDDEN;
	...
	*Graphics解析器
	*/
	//class laya.editorUI.GraphicParser extends laya.display.GraphicAnimation
	var GraphicParser=(function(_super){
		...
		__proto._getTextureByUrl=function(url){
			url=ResFileManager.getIDEResPath(url);
			return _super.prototype._getTextureByUrl.call(this,url);
		}

		GraphicParser.parseAnimationData=function(aniData){
			if (!GraphicParser._I)GraphicParser._I=new GraphicParser();
			GraphicParser._I.setAniData(aniData);
			var rst;
			rst={};
			rst.animationList=GraphicParser._I.animationList;
			rst.animationDic=GraphicParser._I.animationDic;
			return rst;
		}
